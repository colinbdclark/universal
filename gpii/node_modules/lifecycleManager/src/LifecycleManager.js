...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.stop = function (activeSessions, options, callback) {
        ...
        gpii.lifecycleManager.log("The Lifecycle Manager recieved a request to stop all solutions for", options.userToken);
    ...
    gpii.lifecycleManager.start = function (activeSessions, resolver, stop, options, solutions, callback) {
        ...
        gpii.lifecycleManager.log("The Lifecycle Manager recieved a request to start all solutions for", userToken);
