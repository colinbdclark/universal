...
(function () {
    ...
    request.match = function (matchMaker, when, solutions, preferences) {
        ...
        when(matchMaker.match(preferences, solutions, strategy), function (matchedSolutions) {
            ...
            request.log("The Matchmaker strategy returned a list of solutions to set up:\n", matchedSolutionsSummary);
    ...
    request.transformPreferences = function (matchMaker, event, model) {
        ...
        request.log("Requesting ontological transformation from the Ontology Server at:\n     ", ontologyServerURL);

        matchMaker.ontologyServer.set(null, {
            preferences: model.preferences
        }, function (preferences) {
            request.log("The Ontology Server categorized the preference set into the ontology requested by the Matchmaker:\n",
                preferences);
    ...
    request.matchPost = function (that, model) {
        request.log("The Matchmaker Server recieved a request to match a preference set to the available solutions.");
